...
public class SqlCheckSumBasic extends SqlCheckCall implements SqlCheckSum {
    ...
    public SqlCheckSumBasic(SqlParserPos pos, SqlLiteral deltaNum, SqlLiteral normalization, SqlIdentifier table, List<SqlNode> columns) {
        super(pos, table);
