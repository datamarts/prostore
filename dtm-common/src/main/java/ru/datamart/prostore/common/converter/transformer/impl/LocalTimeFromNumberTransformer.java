...
public class LocalTimeFromNumberTransformer extends AbstractColumnTransformer<LocalTime, Number> {

    @Override
    public LocalTime transformValue(Number value) {
        return value != null ? DateTimeUtils.toLocalTime(value.longValue()) : null;
    }
