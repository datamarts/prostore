...
public class LocalDateFromNumberTransformer extends AbstractColumnTransformer<LocalDate, Number> {

    @Override
    public LocalDate transformValue(Number value) {
        return value != null ? DateTimeUtils.toLocalDate(value.longValue()) : null;
    }
