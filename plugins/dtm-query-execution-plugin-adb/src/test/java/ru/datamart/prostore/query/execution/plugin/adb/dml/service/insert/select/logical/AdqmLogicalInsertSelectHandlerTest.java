...
class AdqmLogicalInsertSelectHandlerTest {
    ...
    private AdqmLogicalInsertSelectHandler handler;
    ...
    void setUp(Vertx vertx) {
        ...
        handler = new AdqmLogicalInsertSelectHandler(connectorSqlFactory, databaseExecutor, adqmSharedService, parserService, columnsCastService, enrichmentService, templateExtractor, sqlDialect);
        ...
        handler.handle(request)
                .onComplete(ar -> testContext.verify(() -> {
                    ...
                    assertEquals("CREATE WRITABLE EXTERNAL TABLE datamart.CLICKHOUSE_EXT_abc\n" +
                            "(id int8,col1 int8,col2 int8,col3 int8,col4 int4,sys_from int8,sys_to int8,sys_op int4,sys_close_date int8,sign int4) LOCATION ('pxf://dev__datamart.abc_actual?PROFILE=clickhouse-insert&CLICKHOUSE_SERVERS=clickhouse_server&USER=user&PASSWORD=password&TIMEOUT_CONNECT=1234&TIMEOUT_REQUEST=3456&BUFFER_SIZE=4567')\n" +
