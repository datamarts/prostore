 ...
 */
package ru.datamart.prostore.query.execution.plugin.adb.dml.service.insert;
...
class AdqmInsertSelectHandlerTest {
    ...
    private AdqmInsertSelectHandler handler;
    ...
    void setUp(Vertx vertx) {
        ...
        handler = new AdqmInsertSelectHandler(connectorSqlFactory, databaseExecutor, adqmSharedService, parserService, columnsCastService, enrichmentService, templateExtractor, sqlDialect);
