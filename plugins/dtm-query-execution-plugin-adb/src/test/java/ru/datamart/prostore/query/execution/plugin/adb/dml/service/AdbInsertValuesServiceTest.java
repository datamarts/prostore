...
class AdbInsertValuesServiceTest {
    @Mock
    private AdbLogicalInsertValuesService logicalService;
    @Mock
    private AdbStandaloneInsertValuesService standaloneService;
    @InjectMocks
    ...
    void shouldSuccessWhenWritableType() {
        // arrange
        lenient().when(standaloneService.execute(any())).thenReturn(Future.succeededFuture());
    ...
    void shouldSuccessWhenOtherType() {
        // arrange
        lenient().when(logicalService.execute(any())).thenReturn(Future.succeededFuture());
