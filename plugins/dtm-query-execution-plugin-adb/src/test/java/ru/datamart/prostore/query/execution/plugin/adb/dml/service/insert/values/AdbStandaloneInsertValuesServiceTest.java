...
class AdbStandaloneInsertValuesServiceTest {
    ...
    private AdbStandaloneInsertValuesService service;

    @BeforeEach
    void setUp() {
        service = new AdbStandaloneInsertValuesService(sqlDialect, executor);
    }
