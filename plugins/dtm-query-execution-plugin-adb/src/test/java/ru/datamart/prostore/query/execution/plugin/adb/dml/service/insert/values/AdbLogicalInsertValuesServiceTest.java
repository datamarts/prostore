...
class AdbLogicalInsertValuesServiceTest {
    ...
    private AdbLogicalInsertValuesService service;

    @BeforeEach
    void setUp() {
        service = new AdbLogicalInsertValuesService(sqlDialect, executor, mppwTransferDataHandler);
