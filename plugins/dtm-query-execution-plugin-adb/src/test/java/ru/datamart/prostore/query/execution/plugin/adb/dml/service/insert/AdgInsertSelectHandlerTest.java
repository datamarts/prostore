...
class AdgInsertSelectHandlerTest {
    ...
    private AdgInsertSelectHandler handler;
    ...
    void setUp(Vertx vertx) {
        ...
        handler = new AdgInsertSelectHandler(sqlFactory, databaseExecutor, adgSharedService, parserService, columnsCastService, enrichmentService, templateExtractor, sqlDialect);
