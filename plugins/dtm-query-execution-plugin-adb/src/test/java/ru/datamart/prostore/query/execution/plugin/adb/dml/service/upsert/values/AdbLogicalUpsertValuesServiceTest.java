...
import ru.datamart.prostore.query.execution.plugin.adb.dml.service.AdbUpsertDataTransferService;
...
class AdbLogicalUpsertValuesServiceTest {
    ...
    @InjectMocks
    private AdbLogicalUpsertValuesService service;

    @BeforeEach
    void setUp() {
        service = new AdbLogicalUpsertValuesService(sqlDialect, executor, transferService);
