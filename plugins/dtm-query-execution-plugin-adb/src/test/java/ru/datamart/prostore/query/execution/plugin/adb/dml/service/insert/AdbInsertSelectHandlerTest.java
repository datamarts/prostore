...
class AdbInsertSelectHandlerTest {
    ...
    private AdbInsertSelectHandler handler;
    ...
    void setUp(Vertx vertx) {
        ...
        handler = new AdbInsertSelectHandler(databaseExecutor, parserService, enrichmentService, templateExtractor, sqlDialect, dataTransferService);
