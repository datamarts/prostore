...
@Service("adqmPrepareQueriesOfChangesService")
public class AdqmPrepareQueriesOfChangesService extends PrepareQueriesOfChangesServiceBase {
    public AdqmPrepareQueriesOfChangesService(@Qualifier("adbCalciteDMLQueryParserService") QueryParserService parserService,
                                              @Qualifier("adqmColumnsCastService") ColumnsCastService columnsCastService,
                                              QueryEnrichmentService adbQueryEnrichmentService) {
        super(parserService, columnsCastService, adbQueryEnrichmentService, true);
    }
}
