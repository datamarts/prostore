...
@Service
public class AdqmLogicalInsertSelectHandler implements DestinationInsertSelectHandler {
    ...
    public AdqmLogicalInsertSelectHandler(AdqmConnectorSqlFactory connectorSqlFactory,
