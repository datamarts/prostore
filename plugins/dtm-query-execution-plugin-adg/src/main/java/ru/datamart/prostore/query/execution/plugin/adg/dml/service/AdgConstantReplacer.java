...
@Service("adgConstantReplacer")
public class AdgConstantReplacer extends AbstractConstantReplacer {
    private final PluginSpecificLiteralConverter pluginSpecificLiteralConverter;

    public AdgConstantReplacer(@Qualifier("adgPluginSpecificLiteralConverter") PluginSpecificLiteralConverter pluginSpecificLiteralConverter) {
