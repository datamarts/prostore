...
@Service("adgUpsertValuesService")
public class AdgUpsertValuesService implements UpsertValuesService {

    @Override
    public Future<Void> execute(UpsertValuesRequest request) {
        return Future.failedFuture(new FeatureNotImplementedException("adg upsert values"));
    }
}
