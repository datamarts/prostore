 ...
 */
package ru.datamart.prostore.query.execution.plugin.adg.calcite.service;
...
public class AdgCalciteDMLQueryParserService extends CalciteDMLQueryParserService {
    public AdgCalciteDMLQueryParserService(
            ...
            @Qualifier("adgSchemaExtender") SchemaExtender schemaExtender) {
        super(contextProvider, vertx, schemaExtender);
    }
}
