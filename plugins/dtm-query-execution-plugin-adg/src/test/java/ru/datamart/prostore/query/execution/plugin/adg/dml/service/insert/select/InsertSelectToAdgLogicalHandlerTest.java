...
class InsertSelectToAdgLogicalHandlerTest {
    ...
    private InsertSelectToAdgLogicalHandler handler;
    ...
    void setUp(Vertx vertx) {
        ...
        val constantConverter = new AdgConstantReplacer(pluginSpecificLiteralConverter);

        handler = new InsertSelectToAdgLogicalHandler(queryParserService, queryEnrichmentService, pluginSpecificLiteralConverter, queryTemplateExtractor, queryExecutorService, cartridgeClient, adgHelperTableNamesFactory, sqlDialect, constantConverter);
    ...
    void shouldSuccessWhenConstantsValues(VertxTestContext testContext) {
        ...
        handler.handle(request)
                .onComplete(ar -> testContext.verify(() -> {
                    ...
                    String query = sqlCaptor.getValue();
                    assertEquals("INSERT INTO \"dev__datamart__abc_staging\" (\"id\",\"col1\",\"col2\",\"col3\",\"col4\",\"sys_op\") SELECT 1 AS \"EXPR__0\", 18293 AS \"EXPR__1\", 11554000000 AS \"EXPR__2\", 1580551872000000 AS \"EXPR__3\", TRUE AS \"EXPR__4\", 0 AS \"EXPR__5\" FROM (SELECT \"id\", \"col1\", \"col2\", \"col3\", \"col4\" FROM \"dev__datamart__src_history\" WHERE \"sys_from\" <= 0 AND \"sys_to\" >= 0 UNION ALL SELECT \"id\", \"col1\", \"col2\", \"col3\", \"col4\" FROM \"dev__datamart__src_actual\" WHERE \"sys_from\" <= 0) AS \"t3\"", query);
                }).completeNow());
    }
    ...
    void shouldSuccessWhenConstantsValuesWithIdentifiers(VertxTestContext testContext) {
        ...
        handler.handle(request)
                .onComplete(ar -> testContext.verify(() -> {
                    ...
                    String query = sqlCaptor.getValue();
                    assertEquals("INSERT INTO \"dev__datamart__abc_staging\" (\"id\",\"col1\",\"col2\",\"col3\",\"col4\",\"sys_op\") SELECT \"id\", 18293 AS \"EXPR__1\", 11554000000 AS \"EXPR__2\", 1580551872000000 AS \"EXPR__3\", \"col4\", 0 AS \"EXPR__5\" FROM (SELECT \"id\", \"col1\", \"col2\", \"col3\", \"col4\" FROM \"dev__datamart__src_history\" WHERE \"sys_from\" <= 0 AND \"sys_to\" >= 0 UNION ALL SELECT \"id\", \"col1\", \"col2\", \"col3\", \"col4\" FROM \"dev__datamart__src_actual\" WHERE \"sys_from\" <= 0) AS \"t3\"", query);
                }).completeNow());
    }
    ...
    void shouldSuccessWhenConstantsValuesWithStar(VertxTestContext testContext) {
        // arrange
        val request = getInsertRequest("INSERT INTO datamart.abc SELECT 1, '2020-02-01', '03:12:34', '2020-02-01 10:11:12.0', * FROM datamart.src");
        ...
        handler.handle(request)
                .onComplete(ar -> testContext.verify(() -> {
                    ...
                    String query = sqlCaptor.getValue();
                    assertEquals("INSERT INTO \"dev__datamart__abc_staging\" (\"id\",\"col1\",\"col2\",\"col3\",\"col4\",\"sys_op\") SELECT 1 AS \"EXPR__0\", '2020-02-01' AS \"EXPR__1\", '03:12:34' AS \"EXPR__2\", '2020-02-01 10:11:12.0' AS \"EXPR__3\", \"id\", \"col1\", \"col2\", \"col3\", \"col4\", 0 AS \"EXPR__9\" FROM (SELECT \"id\", \"col1\", \"col2\", \"col3\", \"col4\" FROM \"dev__datamart__src_history\" WHERE \"sys_from\" <= 0 AND \"sys_to\" >= 0 UNION ALL SELECT \"id\", \"col1\", \"col2\", \"col3\", \"col4\" FROM \"dev__datamart__src_actual\" WHERE \"sys_from\" <= 0) AS \"t3\"", query);
                }).completeNow());
    }
