...
class AdpLogicalValuesServiceTest {
    ...
    private AdpLogicalInsertValuesService service;

    @BeforeEach
    void setUp() {
        service = new AdpLogicalInsertValuesService(sqlDialect, executor, mppwTransferDataHandler);
    ...
    void shouldSuccessWhenInsertWithColumns() {
        ...
        assertEquals(Collections.singletonList("id"), mppwRequest.getPrimaryKeys());
    ...
    private InsertValuesRequest getInsertRequest(String s) {
