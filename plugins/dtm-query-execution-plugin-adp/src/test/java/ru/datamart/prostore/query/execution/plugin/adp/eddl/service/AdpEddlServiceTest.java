...
class AdpEddlServiceTest {
    ...
    @InjectMocks
    private AdpEddlService service;
    ...
    @Test
    void shouldFailedWhenCreateEddl(VertxTestContext testContext) {
        //arrange
    ...
    @Test
    void shouldFailedWhenDropEddl(VertxTestContext testContext) {
        //arrange
