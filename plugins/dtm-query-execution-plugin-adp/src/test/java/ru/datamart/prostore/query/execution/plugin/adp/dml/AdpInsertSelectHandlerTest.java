...
import ru.datamart.prostore.query.execution.plugin.adp.dml.insert.AdpInsertSelectHandler;
...
class AdpInsertSelectHandlerTest {
    ...
    private AdpInsertSelectHandler handler;
    ...
    void setUp(Vertx vertx) {
        ...
        handler = new AdpInsertSelectHandler(databaseExecutor, parserService, enrichmentService, templateExtractor, sqlDialect, dataTransferService);
