...
class AdpLogicalInsertSelectHandlerTest {
    ...
    private AdpLogicalInsertSelectHandler handler;
    ...
    void setUp(Vertx vertx) {
        ...
        handler = new AdpLogicalInsertSelectHandler(databaseExecutor, parserService, enrichmentService, templateExtractor, sqlDialect, dataTransferService);
