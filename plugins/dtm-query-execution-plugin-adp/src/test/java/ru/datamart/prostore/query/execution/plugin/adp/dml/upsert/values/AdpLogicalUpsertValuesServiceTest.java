...
class AdpLogicalUpsertValuesServiceTest {
    ...
    @InjectMocks
    private AdpLogicalUpsertValuesService service;

    @BeforeEach
    void setUp() {
        service = new AdpLogicalUpsertValuesService(sqlDialect, executor, transferService);
