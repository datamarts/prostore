 ...
 */
package ru.datamart.prostore.query.execution.plugin.adp.synchronize.service;
...
public class AdpSynchronizeService implements SynchronizeService {
    ...
    public Future<Long> execute(SynchronizeRequest request) {
        return Future.failedFuture(new SynchronizeDatasourceException("Synchronize[ADP] is not implemented"));
    }
}
