...
@Service
public class AdpLogicalInsertSelectHandler implements DestinationInsertSelectHandler {
    ...
    public AdpLogicalInsertSelectHandler(DatabaseExecutor queryExecutor,
