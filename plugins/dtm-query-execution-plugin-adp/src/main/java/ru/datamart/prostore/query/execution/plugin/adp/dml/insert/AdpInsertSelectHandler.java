 ...
 */
package ru.datamart.prostore.query.execution.plugin.adp.dml.insert;
...
@Service
public class AdpInsertSelectHandler implements DestinationInsertSelectHandler {
    ...
    public AdpInsertSelectHandler(DatabaseExecutor queryExecutor,
