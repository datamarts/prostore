...
import static ru.datamart.prostore.query.execution.plugin.adp.dml.factory.AdpStandaloneUpsertSqlFactory.insertSql;
...
@Service
public class AdpStandaloneUpsertValuesService {
    private final SqlDialect sqlDialect;
    private final DatabaseExecutor executor;

    public AdpStandaloneUpsertValuesService(@Qualifier("adpSqlDialect") SqlDialect sqlDialect,
    ...
    public Future<Void> execute(UpsertValuesRequest request) {
        return Future.future(promise -> {
            ...
            val sql = insertSql(destination, targetColumns, newValues.toSqlString(sqlDialect).toString(), entityPk);
