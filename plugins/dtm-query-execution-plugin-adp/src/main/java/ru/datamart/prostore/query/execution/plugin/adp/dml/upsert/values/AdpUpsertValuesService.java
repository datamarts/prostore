...
public class AdpUpsertValuesService implements UpsertValuesService {
    ...
    private final AdpLogicalUpsertValuesService logicalService;
    private final AdpStandaloneUpsertValuesService standaloneService;

    public AdpUpsertValuesService(AdpLogicalUpsertValuesService logicalService, AdpStandaloneUpsertValuesService standaloneService) {
