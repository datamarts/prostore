...
class AdqmUpsertValuesServiceTest {
    ...
    private AdqmUpsertValuesService adqmUpsertService;
    ...
    void shouldSuccessWhenUpsertWithColumns() {
        // arrange
        UpsertValuesRequest request = getUpsertRequest("UPSERT INTO datamart.abc (id, col1, col2) VALUES (1,'2001-01-01','01:01:01'), (2,'2002-02-02','02:02:02'), (3,'2003-03-03','03:03:03')");
    ...
    void shouldFailWhenValuesSizeNotEqualToColumnsSize() {
        // arrange
        UpsertValuesRequest request = getUpsertRequest("UPSERT INTO datamart.abc (id) VALUES (1,'2001-01-01','01:01:01', true)");
    ...
    void shouldFailWhenUnknownField() {
        ...
        UpsertValuesRequest request = new UpsertValuesRequest(UUID.randomUUID(), "dev", "datamart", 1L, entity, sqlNode, null);
    ...
    private UpsertValuesRequest getUpsertRequest(String sql) {
