 ...
 */
package ru.datamart.prostore.query.execution.plugin.adqm.dml.service.insert.logical;
...
class InsertSelectToAdqmLogicalHandlerTest {
    ...
    private InsertSelectToAdqmLogicalHandler handler;
    ...
    void setUp(Vertx vertx) {
        ...
        handler = new InsertSelectToAdqmLogicalHandler(queryParserService, adqmQueryEnrichmentService, adqmCommonSqlFactory, databaseExecutor, pluginSpecificLiteralConverter, queryTemplateExtractor, llrValidationService, constantConverter);
    ...
    void shouldSuccessWhenConstantsValues(VertxTestContext testContext) {
        ...
        handler.handle(request)
                .onComplete(ar -> testContext.verify(() -> {
                    ...
                    List<String> allValues = sqlCaptor.getAllValues();
                    assertEquals("INSERT INTO dev__datamart.abc_actual (id, col1, col2, col3, col4, sys_from, sys_to, sys_op, sys_close_date, sign)  SELECT * FROM (SELECT 1 AS __f0, 18293 AS __f1, 11554000000 AS __f2, 1580551872000000 AS __f3, 1 AS __f4, 1 AS __f5, 9223372036854775807 AS __f6, 0 AS __f7, 9223372036854775807 AS __f8, 1 AS __f9 FROM dev__datamart.src_actual FINAL WHERE sys_from <= 0 AND sys_to >= 0) AS t0 WHERE (((SELECT 1 AS r FROM dev__datamart.src_actual WHERE sign < 0 LIMIT 1))) IS NOT NULL UNION ALL SELECT * FROM (SELECT 1 AS __f0, 18293 AS __f1, 11554000000 AS __f2, 1580551872000000 AS __f3, 1 AS __f4, 1 AS __f5, 9223372036854775807 AS __f6, 0 AS __f7, 9223372036854775807 AS __f8, 1 AS __f9 FROM dev__datamart.src_actual WHERE sys_from <= 0 AND sys_to >= 0) AS t6 WHERE (((SELECT 1 AS r FROM dev__datamart.src_actual WHERE sign < 0 LIMIT 1))) IS NULL", allValues.get(0));
                    assertEquals("SYSTEM FLUSH DISTRIBUTED dev__datamart.abc_actual", allValues.get(1));
                    assertEquals("OPTIMIZE TABLE dev__datamart.abc_actual_shard ON CLUSTER null FINAL", allValues.get(2));
                    assertThat(allValues.get(3), matchesPattern(CLOSE_VERSIONS_PATTERN));
                    assertEquals("SYSTEM FLUSH DISTRIBUTED dev__datamart.abc_actual", allValues.get(4));
    ...
    void shouldSuccessWhenConstantsValuesWithIdentifiers(VertxTestContext testContext) {
        ...
        handler.handle(request)
                .onComplete(ar -> testContext.verify(() -> {
                    ...
                    List<String> allValues = sqlCaptor.getAllValues();
                    assertEquals("INSERT INTO dev__datamart.abc_actual (id, col1, col2, col3, col4, sys_from, sys_to, sys_op, sys_close_date, sign)  SELECT * FROM (SELECT id, 18293 AS __f1, 11554000000 AS __f2, 1580551872000000 AS __f3, col4, 1 AS __f5, 9223372036854775807 AS __f6, 0 AS __f7, 9223372036854775807 AS __f8, 1 AS __f9 FROM dev__datamart.src_actual FINAL WHERE sys_from <= 0 AND sys_to >= 0) AS t0 WHERE (((SELECT 1 AS r FROM dev__datamart.src_actual WHERE sign < 0 LIMIT 1))) IS NOT NULL UNION ALL SELECT * FROM (SELECT id, 18293 AS __f1, 11554000000 AS __f2, 1580551872000000 AS __f3, col4, 1 AS __f5, 9223372036854775807 AS __f6, 0 AS __f7, 9223372036854775807 AS __f8, 1 AS __f9 FROM dev__datamart.src_actual WHERE sys_from <= 0 AND sys_to >= 0) AS t6 WHERE (((SELECT 1 AS r FROM dev__datamart.src_actual WHERE sign < 0 LIMIT 1))) IS NULL", allValues.get(0));
                    assertEquals("SYSTEM FLUSH DISTRIBUTED dev__datamart.abc_actual", allValues.get(1));
                    assertEquals("OPTIMIZE TABLE dev__datamart.abc_actual_shard ON CLUSTER null FINAL", allValues.get(2));
                    assertThat(allValues.get(3), matchesPattern(CLOSE_VERSIONS_PATTERN));
                    assertEquals("SYSTEM FLUSH DISTRIBUTED dev__datamart.abc_actual", allValues.get(4));
    ...
    void shouldSuccessWhenConstantsValuesWithStar(VertxTestContext testContext) {
        // arrange
        val request = getInsertRequest("INSERT INTO datamart.abc  SELECT id, '2020-02-01', '03:12:34', '2020-02-01 10:11:12.0', * FROM datamart.src");
        ...
        handler.handle(request)
                .onComplete(ar -> testContext.verify(() -> {
                    ...
                    List<String> allValues = sqlCaptor.getAllValues();
                    assertEquals("INSERT INTO dev__datamart.abc_actual (id, col1, col2, col3, col4, sys_from, sys_to, sys_op, sys_close_date, sign)  SELECT * FROM (SELECT id, '2020-02-01' AS __f1, '03:12:34' AS __f2, '2020-02-01 10:11:12.0' AS __f3, id AS id0, col1, col2, col3, col4, 1 AS __f9, 9223372036854775807 AS __f10, 0 AS __f11, 9223372036854775807 AS __f12, 1 AS __f13 FROM dev__datamart.src_actual FINAL WHERE sys_from <= 0 AND sys_to >= 0) AS t0 WHERE (((SELECT 1 AS r FROM dev__datamart.src_actual WHERE sign < 0 LIMIT 1))) IS NOT NULL UNION ALL SELECT * FROM (SELECT id, '2020-02-01' AS __f1, '03:12:34' AS __f2, '2020-02-01 10:11:12.0' AS __f3, id AS id0, col1, col2, col3, col4, 1 AS __f9, 9223372036854775807 AS __f10, 0 AS __f11, 9223372036854775807 AS __f12, 1 AS __f13 FROM dev__datamart.src_actual WHERE sys_from <= 0 AND sys_to >= 0) AS t6 WHERE (((SELECT 1 AS r FROM dev__datamart.src_actual WHERE sign < 0 LIMIT 1))) IS NULL", allValues.get(0));
                    verifyNoMoreInteractions(databaseExecutor);
                }).completeNow());
    }
