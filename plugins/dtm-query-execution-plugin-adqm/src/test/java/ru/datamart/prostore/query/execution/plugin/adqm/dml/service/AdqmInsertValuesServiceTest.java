...
class AdqmInsertValuesServiceTest {
    ...
    private AdqmInsertValuesService service;
    ...
    void setUp() {
        ...
        service = new AdqmInsertValuesService(new AdqmPluginSpecificLiteralConverter(), adqmDmlSqlFactory, databaseExecutor);
    ...
    void shouldSuccessWhenInsertWithColumns() {
        // arrange
        InsertValuesRequest request = getInsertRequest("INSERT INTO datamart.abc (id, col1, col2) VALUES (1,'2001-01-01','01:01:01'), (2,'2002-02-02','02:02:02'), (3,'2003-03-03','03:03:03')");
    ...
    void shouldFailWhenValuesSizeNotEqualToColumnsSize() {
        // arrange
        InsertValuesRequest request = getInsertRequest("INSERT INTO datamart.abc (id) VALUES (1,'2001-01-01','01:01:01', true)");
    ...
    void shouldFailWhenUnknownField() {
        // arrange
        SqlInsert sqlNode = (SqlInsert) TestUtils.DEFINITION_SERVICE.processingQuery("INSERT INTO datamart.abc (col_unknown) VALUES ((1))");
    ...
    void shouldFailWhenNoPkFieldInColumns() {
        // arrange
        SqlInsert sqlNode = (SqlInsert) TestUtils.DEFINITION_SERVICE.processingQuery("INSERT INTO datamart.abc (col1) VALUES ('2001-01-01','01:01:01')");
        Entity entity = Entity.builder()
                .name("abc")
                .fields(Arrays.asList(
                        EntityField.builder()
    ...
    void shouldFailWhenFirstDatabaseExecuteFailed() {
        ...
        SqlInsert sqlNode = (SqlInsert) TestUtils.DEFINITION_SERVICE.processingQuery("INSERT INTO datamart.abc VALUES (1,'2001-01-01','01:01:01', '2001-01-01 01:01:01')");
        Entity entity = Entity.builder()
                .name("abc")
                .fields(Arrays.asList(
                        EntityField.builder()
