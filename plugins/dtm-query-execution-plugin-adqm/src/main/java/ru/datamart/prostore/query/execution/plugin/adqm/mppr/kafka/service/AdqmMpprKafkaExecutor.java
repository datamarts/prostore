...
public class AdqmMpprKafkaExecutor implements AdqmMpprExecutor {
    ...
    public Future<QueryResult> execute(MpprRequest request) {
        ...
        return queryParserService.parse(new QueryParserRequest(kafkaRequest.getDmlSubQuery(), kafkaRequest.getLogicalSchema(), kafkaRequest.getEnvName()))
                .compose(parserResponse ->
                {
                    val isSimple = isSimple(parserResponse.getRelNode());
                    val enrichRequest = EnrichQueryRequest.builder()
                            ...
                            .isLocal(isSimple)
                            .build();
                    return adqmQueryEnrichmentService.enrich(enrichRequest)
