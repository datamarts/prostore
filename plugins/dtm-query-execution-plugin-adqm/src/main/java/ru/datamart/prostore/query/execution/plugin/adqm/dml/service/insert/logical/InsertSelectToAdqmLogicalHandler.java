...
@Component
public class InsertSelectToAdqmLogicalHandler implements DestinationInsertSelectHandler {
    ...
    public InsertSelectToAdqmLogicalHandler(@Qualifier("adqmCalciteDMLQueryParserService") QueryParserService queryParserService,
    ...
    public Future<Void> handle(InsertSelectRequest request) {
        return Future.future(promise -> {
            ...
            val constantReplacedQuery = constantReplacer.replace(logicalFields, request.getSourceQuery());
            val source = extendQuerySelectColumns(constantReplacedQuery, columnsToAdd);
