...
@Component
public class CreateWriteableExternalTableExecutor extends CreateStandaloneExternalTableExecutor {

    public CreateWriteableExternalTableExecutor(DataSourcePluginService dataSourcePluginService,
                                                EntityDao entityDao,
    ...
    public EddlAction getAction() {
        return EddlAction.CREATE_WRITEABLE_EXTERNAL_TABLE;
    }
