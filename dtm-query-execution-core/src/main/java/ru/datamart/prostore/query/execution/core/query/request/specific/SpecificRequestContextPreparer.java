...
public interface SpecificRequestContextPreparer {
    int DEFAULT_PRIORITY = 100;

    Future<CoreRequestContext<? extends DatamartRequest, ? extends SqlNode>> create(QueryRequest request, SqlNode node);

    boolean isApplicable(SqlNode node);
