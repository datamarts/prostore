...
@Slf4j
@Component
public class GetDeltaByNumExecutor extends DeltaServiceDaoExecutorHelper implements DeltaDaoExecutor {

    @Autowired
    public GetDeltaByNumExecutor(ZookeeperExecutor executor,
