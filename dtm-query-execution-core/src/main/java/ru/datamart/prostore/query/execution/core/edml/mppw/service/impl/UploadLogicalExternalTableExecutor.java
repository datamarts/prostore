...
import static ru.datamart.prostore.query.execution.core.edml.dto.EdmlAction.UPLOAD_LOGICAL;

@Service
@Slf4j
public class UploadLogicalExternalTableExecutor implements EdmlExecutor {
    ...
    @Autowired
    public UploadLogicalExternalTableExecutor(DeltaServiceDao deltaServiceDao,
    ...
    public Future<QueryResult> execute(EdmlRequestContext context) {
        return Future.future(promise -> isEntitySourceTypesExistsInConfiguration(context.getDestinationEntity())
                ...
                .onComplete(f -> BreakMppwContext.removeTask(
    ...
    private Future<QueryResult> executeAndWriteOp(EdmlRequestContext context) {
        return Future.future(promise ->
                initLogicalSchema(context)
                        ...
                        .onFailure(error -> deltaServiceDao.writeOperationError(context.getDestinationEntity().getSchema(), context.getSysCn())
