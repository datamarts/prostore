...
@Component
public class EddlRequestContextPreparer implements SpecificRequestContextPreparer {
    private final AppConfiguration coreConfiguration;

    public EddlRequestContextPreparer(AppConfiguration coreConfiguration) {
    ...
    public Future<CoreRequestContext<? extends DatamartRequest, ? extends SqlNode>> create(QueryRequest request, SqlNode node) {
        return Future.succeededFuture(EddlRequestContext.builder()
