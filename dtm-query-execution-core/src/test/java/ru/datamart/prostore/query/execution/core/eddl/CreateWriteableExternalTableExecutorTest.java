...
import ru.datamart.prostore.query.execution.core.eddl.service.standalone.CreateWriteableExternalTableExecutor;
...
class CreateWriteableExternalTableExecutorTest {
    ...
    private final static CreateStandaloneExternalTableQuery QUERY_WITH_CREATE = CreateStandaloneExternalTableQuery.builder()
            ...
            .build();
    private final static CreateStandaloneExternalTableQuery QUERY_WITHOUT_CREATE = CreateStandaloneExternalTableQuery.builder()
            .eddlAction(EddlAction.CREATE_WRITEABLE_EXTERNAL_TABLE)
            .envName(ENV)
            .schemaName(DATAMART)
    ...
    @InjectMocks
    private CreateWriteableExternalTableExecutor executor;
    ...
    void shouldSuccessWhenAutoCreateTrue(VertxTestContext testContext) {
        ...
        executor.execute(QUERY_WITH_CREATE)
                .onComplete(ar -> testContext.verify(() -> {
                    ...
                    verify(datamartDao, times(1)).existsDatamart(DATAMART);
    ...
    void souldReturnCorrectEddlAction() {
        assertEquals(EddlAction.CREATE_WRITEABLE_EXTERNAL_TABLE, executor.getAction());
    }
