...
class GetDeltaOkServiceTest {
    ...
    private DeltaService deltaOkService;
    ...
    void setUp() {
        ...
        deltaOkService = new GetDeltaOkService(serviceDbFacade, deltaQueryResultFactory);
    }
    ...
    void executeSuccess() {
        ...
        deltaOkService.execute(deltaQuery)
                .onComplete(promise);
