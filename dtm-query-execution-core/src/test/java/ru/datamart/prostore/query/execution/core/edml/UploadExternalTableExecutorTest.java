...
import ru.datamart.prostore.query.execution.core.edml.mppw.service.impl.UploadKafkaExecutor;
...
class UploadExternalTableExecutorTest {
    ...
    private DefinitionService<SqlNode> definitionService = new CoreCalciteDefinitionService(config.configEddlParser(calciteCoreConfiguration.eddlParserImplFactory()));
    ...
    void setUp() {
        ...
        lenient().when(logicalSchemaProvider.getSchemaFromQuery(any(), any())).thenReturn(Future.succeededFuture(Collections.EMPTY_LIST));
