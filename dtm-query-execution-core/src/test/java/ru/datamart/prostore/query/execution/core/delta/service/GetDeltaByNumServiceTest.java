...
class GetDeltaByNumServiceTest {
    ...
    private DeltaService deltaByNumService;
    ...
    void setUp() {
        ...
        deltaByNumService = new GetDeltaByNumService(serviceDbFacade, deltaQueryResultFactory);
    }
    ...
    void executeSuccess() {
        ...
        deltaByNumService.execute(deltaQuery)
                .onComplete(promise);
