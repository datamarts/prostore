...
import ru.datamart.prostore.query.execution.core.ddl.service.impl.view.AlterViewExecutor;
...
class AlterViewExecutorTest {
    ...
    @Test
    void shouldFailWhenInformationSchemaValidateFailed(VertxTestContext testContext) throws SqlParseException {
        DtmCalciteFramework.ConfigBuilder configBuilder = DtmCalciteFramework.newConfigBuilder();
        FrameworkConfig frameworkConfig = configBuilder.parserConfig(parserConfig).build();
        Planner planner = DtmCalciteFramework.getPlanner(frameworkConfig);
