 ...
 */
package io.arenadata.dtm.query.execution.core.ddl.matview;
...
class CreateMaterializedViewExecutorTest {
    ...
    void shouldAddAliasesToViewQueryColumnsWithCast() {
        ...
        val processedQuery = "CREATE MATERIALIZED VIEW matviewdatamart.mat_view (id_field INTEGER NOT NULL, name_field VARCHAR(100), PRIMARY KEY (id_field)) DISTRIBUTED BY (id_field) DATASOURCE_TYPE (adg) AS\n" +
